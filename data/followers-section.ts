...
export const FollowersSectionData: ISectionWithButtons = {
  sectionTitle: "Troubles Growing Your Audience?",
  sectionSubtitle: 'Thinking "Outside The Box"',
  sectionButtonOne: {sectionButtonOneText: "Start Driving Sales"},
  sectionBody:
